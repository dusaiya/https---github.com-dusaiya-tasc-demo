...
package com.ict.nasc.tasc.app.module.screen.simple;
 ...
 * <p/>
 * 此程序展示了 种技术，能让页面 边生成 一边展示给用户。虽然页面还没有完全生成，但用户已经能够看到部分页面
 * 这不仅改善了用户的体验，也使浏览器处理页面 下载 服务器生成页面三 实现了并发，从而加快了显示页面的 时间 
 *
 * @author Michael Zhou
 */
public class Count {
